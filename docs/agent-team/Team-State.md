...
Owner: advisor (single writer). Specialists report through handoffs in `handoffs/`;
the advisor records here. Last updated: 2026-09-08.
...
| verifier | idle | await first lane handoff | none yet |

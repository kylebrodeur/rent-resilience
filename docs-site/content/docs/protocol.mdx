...
[`packages/protocol/schemas/`](https://github.com/kylebrodeur/rent-resilience/blob/main/). Everything else in the
...
|---|---|---|
| `RentObligation` | [`rent-obligation.v0.1.schema.json`](https://github.com/kylebrodeur/rent-resilience/blob/main/) | A verifiable housing obligation (what is owed, by whom, when). |
| `RentEvent` | [`rent-event.v0.1.schema.json`](https://github.com/kylebrodeur/rent-resilience/blob/main/) | An append-only, signed fact about an obligation. |
